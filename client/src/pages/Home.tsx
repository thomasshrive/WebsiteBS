  ...
  return (
    <div className="flex flex-col">
      <SEO 
        ...
        description="We manage your building's compliance end-to-end. We track requirements, arrange inspections, and keep the evidence audit-ready."
        path="/"
      />
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed" data-testid="text-hero-subtitle">
              We manage your building's compliance end-to-end. We track requirements, arrange inspections, and keep the evidence audit-ready.
            </p>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <div className="text-center" data-testid="step-4">
              ...
              <h3 className="font-semibold text-xl mb-3">We take care of the rest</h3>
              <p className="text-muted-foreground leading-relaxed">
                Coordinating inspections, chasing suppliers, and keeping evidence up to date.
              </p>
            </div>
          </div>
        </div>
